...
$$
\hat{y}_j = \sum_{i=1}^n y_i h_{j,i}
$$


So if $h_{jj} \approx 1$ then the $j$th observation has a lot of *leverage* in determing the $j$th prediction.

Rule of thumb: flag row $j$ when $\mathbf{H}_{jj} > 3 \frac{k+1}{n}$
